...
turnos= [
    {fecha: 4, mes: "Abril", turno:"Mañana",especialidad: "Cardiología", medico: "Juan Pérez"},
    {fecha: 17, mes: "Abril", turno:"Mañana", especialidad: "Dermatología", medico: "Yanina Durán",},
    {fecha: 26, mes: "Abril", turno:"Tarde", especialidad: "Ginecología", medico: "Luis Soto",},
    {fecha: 6, mes: "Mayo", turno:"Tarde", especialidad: "Alergias", medico: "Florencia Molina",},
    {fecha: 10, mes: "Mayo", turno:"Tarde",especialidad: "Fonoaudiología", medico: "Carmen Bueno",},
];    
...
const cardsMisTurnos=() =>{
    turnos.forEach((element) => {
        detalleTurnos= `${element.fecha}, ${element.mes}, ${element.turno}, ${element.especialidad}, ${element.medico} `
